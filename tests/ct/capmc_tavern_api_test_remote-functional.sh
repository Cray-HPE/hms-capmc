...
#       all CAPMC Tavern API CT tests using DST's ct-pipelines container
...
#         /opt/cray/tests/remote-functional/hms/hms-capmc in the
#         ct-pipelines container.
#       - capmc_node_rules_default_config_ncn-functional_remote-functional.yaml
#         which is expected to be packaged in
#         /opt/cray/tests/remote-functional/hms/hms-capmc on the NCN.
#
#     BUGS/LIMITATIONS
#       None
#
...
PYTEST_INI_PATH="/opt/cray/tests/remote-functional/hms/hms-capmc/pytest.ini"
...
COMMON_FILE_PATH="/opt/cray/tests/remote-functional/hms/hms-capmc/common.yaml"
CAPMC_NODE_RULES_DEFAULT_CONFIG_FILE_PATH="/opt/cray/tests/remote-functional/hms/hms-capmc/capmc_node_rules_default_config_ncn-functional_remote-functional.yaml"
CAPMC_TEST_DIR="/opt/cray/tests/remote-functional/hms/hms-capmc"
